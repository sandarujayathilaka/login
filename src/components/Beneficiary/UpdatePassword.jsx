...
function UpdatePassword() {
    ...
    //       };
    //       const response = await axios.get(GET_Employee_URL, config);
          
    //       const filteredUsers = response.data.filter((user) => user.username === auth.user);
    //       console.log(filteredUsers[0].password)
    //       setUserpwd(filteredUsers[0].password);
    //     } catch (err) {
    //       console.error(err);
